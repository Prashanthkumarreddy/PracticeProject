...
<body background="images/banffcanada.jpg">
    ...
    <form method="get" action="http://localhost:8080/CapServlet/update">
	<table border="0" cellspacing="10px" align="center">
  <tr>
  <td>employee id:<input type="number" name="id" placeholder="enter the user id"></td></tr>
  <tr>
  <td>employee name:<input type="text" name="name" placeholder="enter the user name"></td></tr>
  <tr>
  <td>Update Password:<input type="password" name="password"/></td>
  </tr>
  <tr>

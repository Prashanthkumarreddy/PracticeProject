	...
	<div class="limiter">
		<div class="container-login100">
		  <div class="login100-more" style="background-image: url('images/bg-01.jpg');"></div>
			...
			action="http://localhost:8080/CapServlet/register">
					<span class="login100-form-title p-b-59">
						Register
					</span>

					<div class="wrap-input100 validate-input" data-validate="id is required">
						<span class="label-input100">employee_id</span>
						<input class="input100" type="number" name="empid" placeholder="e_id...">
					...
					<div class="wrap-input100 validate-input" data-validate="salary is required">
						...
						<input class="input100" type="number" name="sal" placeholder="salary...">
						<span class="focus-input100"></span>
					</div>

					
					<div class="wrap-input100 validate-input" data-validate="salary is required">
						<span class="label-input100">Manager_id</span>
						<input class="input100" type="number" name="mgr" placeholder="Manager_id...">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate="Deptment name is required">
						<span class="label-input100">Department name</span>
						<input class="input100" type="text" name="dpt" placeholder="Department...">
						<span class="focus-input100"></span>
					</div>
